...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.ItemHolder> {
    ...
    public ItemHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        switch (viewType) {
            case 0:
                View v0 = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_song, viewGroup, false);
                return new ItemHolder(v0);
            case 1:
                View v1 = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_album_search, viewGroup, false);
                return new ItemHolder(v1);
            case 2:
                View v2 = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_artist, viewGroup, false);
            ...
            default:
                View v3 = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_song, viewGroup, false);
    ...
    public class ItemHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        final TextView artisttitle;
        final TextView albumartist;
        final TextView albumsongcount;
