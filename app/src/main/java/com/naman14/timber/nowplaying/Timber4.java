...
public class Timber4 extends BaseNowplayingFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_timber4, container, false);
    }
    ...
    protected void buildTransportControls() {
        ...
        horizontalRecyclerview = (RecyclerView) getView().findViewById(R.id.queue_recyclerview_horizontal);
